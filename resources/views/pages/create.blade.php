        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <form action="{{route('pages.store')}}" method="post" role="form" class="php-email-form" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="name">Page Title</label>
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('detailed_content') is-invalid @enderror" id="detailed_content" name="detailed_content" rows="10" data-rule="required" data-msg="Please write something for us"></textarea>
